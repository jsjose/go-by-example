...
func main() {
	...
	// If you just wanted to wait, you could have used time.Sleep. One reason a timer may be useful is that you
	// can cancel the timer before it expires. Here’s an example of that.
